...
the architecture provides an optional virtual domain extension that
includes registers for domain address translation, domain routing and
context switching for system traps, domain traps, and capability
traps. capability trap routing requires both the virtual domains and
capabities extensions to be present and enabled.
\\
\par\noindent
