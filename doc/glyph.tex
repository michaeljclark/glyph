...
\begin{itemize}[itemsep=0pt]
\item \emph{user} --- virtual memory visible to unprivileged software with the \emph{user} capability.
\item \emph{system} --- virtual memory visible to privileged software with the \emph{system} capability.
\item \emph{physical} --- physical memory that is visible globally and has well-defined ordering rules.
