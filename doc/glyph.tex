...
a \emph{load-store} architecture~\cite{cocke1980risc} is a way to
...
instruction memory~\cite{aiken1946marki} is a memory region dedicated to
instructions. it is organized as a word-addressable store like main-memory,
but is read-only and restricted to instructions.
\\
\par\noindent
...
but is read-only and restricted to constants.
\\
\par\noindent
