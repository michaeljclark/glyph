...
\node [font=\tiny,anchor=base] at (31.5,1.25)  {\textsf{0}};
\node [font=\tiny,anchor=base] at (24.5,1.25)  {$\mathit{ncol}$};
\node [font=\small,anchor=base] at (28.0,0.25)  {\emph{system caps}};
\end{tikzpicture}
...
\node [font=\tiny,anchor=base] at (31.5,1.25)  {\textsf{0}};
\node [font=\tiny,anchor=base] at (24.5,1.25)  {$\mathit{ncol}$};
\node [font=\small,anchor=base] at (28.0,0.25)  {\emph{dom caps}};
\end{tikzpicture}
...
\node [font=\tiny,anchor=base] at (31.5,1.25)  {\textsf{0}};
\node [font=\tiny,anchor=base] at (24.5,1.25)  {$\mathit{ncol}$};
\node [font=\small,anchor=base] at (28.0,0.25)  {\emph{cap caps}};
\end{tikzpicture}
