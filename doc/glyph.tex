...
\hline
\multicolumn{3}{|l|}{\textbf{floating-point math registers}} \\
\hline
...
\newpage
\subsection{floating-point math registers}
the section describes the user-level floating-point math registers.
...
\textbf{no.} & \textbf{name} & \textbf{description} \\
\hline
\verb|1 << 0| & F   & floating-point math enabled \\
...
\textbf{no.} & \textbf{name} & \textbf{description} \\
\hline
\verb|1 << 0| & F   & floating-point math feature \\
...
includes capability registers controlling permissions and capabilities
enabled by \emph{page table color} bits in page table entries.
\\
\par\noindent
...
and they are available when \texttt{scontrol.C} is enabled and the
associated executable page table colors are configured in \emph{colorcap}.
\\
\par\noindent
...
\hline
\texttt{0x40} & colorread      & color read permissions \\
\texttt{0x41} & colorwrite     & color write permissions \\
\texttt{0x42} & colorexec      & color exec permissions \\
\hline
\multicolumn{3}{|l|}{\textbf{color capability registers}} \\
\hline
\texttt{0x43} & colorsys       & color system capabilities \\
\texttt{0x44} & colordom       & color domain capabilities \\
\texttt{0x45} & colorcap       & color capability capabilities \\
\hline
...
entry contains a physical page number along with several permission and
metadata bits. the physical page number either points to the next page
...
\node [font=\small,anchor=base] at (13,0.25)  {\emph{physical page number}};
