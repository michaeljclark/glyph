...
\node [font=\tiny,anchor=base] at (0.25,11.2)  {\textsf{0}};
\node [font=\tiny,anchor=base east] at (8,11.2)  {\textsf{ALEN}};
\node [font=\tiny,anchor=base east] at (16,8.2)  {\textsf{XLEN}};

\fill [black!5] (0,9)    rectangle (8,10);
\draw [black!95] (0,9)    rectangle (8,10);

\fill [black!5] (0,10)    rectangle (8,11);
\draw [black!95] (0,10)    rectangle (8,11);

\fill [black!5] (0,-2)    rectangle (2,-1);
\draw [black!95] (0,-2)    rectangle (2,-1);

\node [font=\small,anchor=base] at (4,9.25)  {\textsf{ib}};
\node [font=\small,anchor=base] at (4,10.25)  {\textsf{pc}};
\node [font=\small,anchor=base] at (1,-1.75)  {\textsf{flag}};

\node [font=\tiny,anchor=base west] at (0.25,9.25)  {\textsf{000000}};
\node [font=\tiny,anchor=base west] at (0.25,10.25)  {\textsf{0}};
