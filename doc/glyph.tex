...
from executable pages with a system or physical address spaces.
...
\texttt{0x23} & sptr      & system page table root \\
\texttt{0x24} & saddr     & system thread address \\
\texttt{0x25} & sdomain   & system thread domain \\
\texttt{0x26} & starget   & system target address \\
\texttt{0x27} & smessage  & system target message \\
