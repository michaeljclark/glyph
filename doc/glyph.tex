...
to the domain in this register when the domain feature is enabled in
\texttt{scontrol.V}.
\\
\par\noindent
\begin{tikzpicture}[scale=0.45]
...
feature is enabled in \texttt{scontrol.V}.
\\
\par\noindent
\begin{tikzpicture}[scale=0.45]
\draw [black!95] (0,0)    rectangle (32,1);
...
capabilities features are both enabled in \texttt{scontrol.V} and
\texttt{scontrol.C}. this register is present if both the domain and
capability features are present.
\\
\par\noindent
\begin{tikzpicture}[scale=0.45]
\draw [black!95] (0,0)    rectangle (32,1);
...
context switch to the domain in this register when the domain and
machine features are both enabled in \texttt{scontrol.V} and
\texttt{scontrol.M}. this register is present if both the domain and
machine features are present.
\\
\par\noindent
\begin{tikzpicture}[scale=0.45]
\draw [black!95] (0,0)    rectangle (32,1);
...
each domain. when the domain feature is present and enabled in
\texttt{scontrol.V} then domain fault context switches will cause the
...
for address translation in each domain. when the domain feature is present
and is enabled in \texttt{scontrol.V} then domain fault context switches
...
relation to the page table root for the domain. when the domain feature is
present and is enabled in \texttt{scontrol.V} then domain fault context
