...
\hline
\texttt{0x2000...0x200f} & domsys$[n]$    & domain system default domain \\
\texttt{0x3000...0x300f} & domdom$[n]$    & domain domain default domain \\
\texttt{0x4000...0x400f} & domcap$[n]$    & domain capability default domain \\
\hline
\multicolumn{3}{|l|}{\textbf{domain context registers}} \\
\hline
\texttt{0x5000...0x500f} & domaddr$[n]$   & domain address \\
\texttt{0x6000...0x600f} & domptr$[n]$    & domain page table root \\
\texttt{0x7000...0x700f} & domthpc$[n]$   & domain trap handler program counter  \\
\texttt{0x8000...0x800f} & domthib$[n]$   & domain trap handler immediate base \\
\hline
\end{tabularx}
