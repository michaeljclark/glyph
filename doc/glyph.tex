...
by the assembler. an object file cannot be run, rather it is used as input
...
sometimes referred to as static libraries. archive files use a simple
...
contain the index listing the object files without the associated data.

\subsection{executable}
executable files contain compiled relocatable object code and data
that has been linked together by a linker in a linking step
using multple object files, archive files and libraries as input.
executable files can be statically or dynamically linked. dynamically
linked executables files express dependencies on libraries which are
loaded at runtime.
