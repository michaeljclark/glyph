...
\texttt{sversion} is a read-only register containing the system version
number described by the \emph{major}, \emph{minor}, and \emph{patch} fields.
\\
\par\noindent
\begin{tikzpicture}[scale=0.45]
\draw [black!95] (0,0)    rectangle (32,1);
...
\node [font=\tiny,anchor=base] at (24.5,1.25)  {\textsf{8}};
\node [font=\tiny,anchor=base] at (27.5,1.25)  {\textsf{15}};
\node [font=\small,anchor=base] at (26.0,0.25)  {\emph{minor}};
\draw [black!95] (20.0,0)   rectangle (24.0,1);
\node [font=\tiny,anchor=base] at (20.5,1.25)  {\textsf{16}};
\node [font=\tiny,anchor=base] at (23.5,1.25)  {\textsf{23}};
