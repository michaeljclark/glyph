...
\begin{itemize}[itemsep=0pt]
\item \emph{user} --- virtual memory accessible to unprivileged software with \emph{user} capability.
\item \emph{system} --- virtual memory accessible to privileged software with \emph{system} capability.
