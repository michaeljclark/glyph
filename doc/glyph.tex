...
in instruction immediate values or indirectly with constants that are accessed
using \emph{ib-relative} addresses stored inside instruction register slots.
\\
\par\noindent
