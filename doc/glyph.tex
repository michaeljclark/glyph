...
extensions for capabilities, virtual domains and software-defined
memory management. the capability extension adds fine-grained page-based
permissions and role based access control. the domain extension adds
virtualization for trap routing, page translation, and context switching.
the machine extension provides for custom address translation schemes.
\\
\par\noindent
