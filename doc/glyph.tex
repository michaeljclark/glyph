...
\hline
\texttt{0x1000...0x100f} & domsys$[n]$    & domain system default domain \\
\texttt{0x2000...0x200f} & domdom$[n]$    & domain domain default domain \\
\texttt{0x3000...0x300f} & domcap$[n]$    & domain capability default domain \\
\hline
...
\texttt{0x6000...0x600f} & domthpc$[n]$   & domain trap handler program counter  \\
\texttt{0x7000...0x700f} & domthib$[n]$   & domain trap handler immediate base \\
\hline
\end{tabularx}
