...
in the previous packet~\cite{US6877084B1}. instruction words can
begin on any 16-bit aligned address.
...
instructions and one with constants~\cite{Solomonoff1964}. the instruction
stream is addressed with the \emph{program counter (pc)} and the constant
stream is addressed with the \emph{immediate base (ib)} register.
