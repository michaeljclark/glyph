...
\subsection{template architectural profile}
...
\par\noindent
the following diagram shows the template architectural profile
register state:
\\
...
\end{scope}
\end{tikzpicture}
\caption{template architectural profile register state.}
\label{fig:glyph-register-state-template}
\end{figure}

\newpage
\subsection{\emph{scalar-min} architectural profile}
...
\par\noindent
the following diagram shows the \emph{scalar-min} architectural profile
register state:
\\
...
\end{scope}
\end{tikzpicture}
\caption{\emph{scalar-min} architectural profile register state.}
...
\newpage
\subsection{\emph{scalar-max} architectural profile}
...
\par\noindent
the following diagram shows the \emph{scalar-max} architectural profile
register state:
\\
...
\end{scope}
\end{tikzpicture}
\caption{\emph{scalar-max} architectural profile register state.}
...
\newpage
\subsection{\emph{vector-min} architectural profile}
...
\par\noindent
the following diagram shows the \emph{vector-min} architectural profile
register state:
\\
...
\end{scope}
\end{tikzpicture}
\caption{\emph{vector-min} architectural profile register state.}
\label{fig:glyph-register-state-vector-min}
\end{figure}

\newpage
\subsection{\emph{vector-max} architectural profile}
...
\par\noindent
the following diagram shows the \emph{vector-max} architectural profile
register state:
\\
...
\end{scope}
\end{tikzpicture}
\caption{\emph{vector-max} architectural profile register state.}
...
the following table lists scalar types used by the assembler:
...
\subsection{\width-bit vector types \texttt{(L=0b\bits)}}

the following table lists \width-bit vector types used by the assembler:
