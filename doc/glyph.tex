...
reduced so that vectorized instruction decoding is easier in software.
the scheme is designed so that \emph{1-bit} of coding space in the
larger packet can be used to extend register sizes.
...
\hline
\textbf{Packets} & \textbf{Bits} & \textbf{Bytes} & \textbf{Combinations} \\
\hline
1-wide  & 16-bit   & 2  & 1     \\
2-wide  & 32-bit   & 4  & 16    \\
4-wide  & 64-bit   & 8  & 58    \\
8-wide  & 128-bit  & 16 & 574   \\
16-wide & 256-bit  & 32 & 51904 \\
\hline
\end{tabular}
