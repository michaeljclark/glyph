...
the following table lists scalar types with their symbols, mnemonics and descriptions:
...
the following table lists \width-bit vector types with their symbols, mnemonics and descriptions:
