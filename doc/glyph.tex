...
\emph{ib-relative} addresses within register slots.
\\
\par\noindent
constant memory is addressed using \emph{ib-relative} addresses within
register slots, which are typed, scaled and aligned addresses computed
relative to an \emph{immediate base} register, which is like a program
