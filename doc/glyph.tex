...
trap handler to perform address translation by walking the page tabl
estructures and populating the TLB\footnote{Translation Lookaside Buffer}
...
this register is populated by the page translation miss fault handler with
a physical page number, a page color, plus several permission and metadata
bits in the same format as the metadata bits defined for page table entries.
table~\ref{tab:64-bit-page-table-entry-fields} in the address translation
section describes the metadata bits.
